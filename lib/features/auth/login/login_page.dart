          ...
          child: Column(
            ...
            children: [
              TextField(
                ...
                onChanged: (text) => presenter.usernameChanged(text),
              ),
              ...
              TextField(
                ...
                onChanged: (text) => presenter.passwordChanged(text),
              ),
              ...
              stateObserver(
                builder: (context, state) => state.isLoading
                    ...
                    : ElevatedButton(
                        onPressed: state.isLoginEnabled ? () => presenter.onLoginButtonTapped() : null,
